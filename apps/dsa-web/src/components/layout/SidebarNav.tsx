...
import { Activity, BarChart3, Bell, BriefcaseBusiness, Gauge, Home, ListFilter, LogOut, MessageSquareQuote, Search, Settings2 } from 'lucide-react';
...
const NAV_ITEMS: NavItem[] = [
  ...
  { key: 'stocks', labelKey: 'layout.nav.stocks', to: '/stocks', icon: ListFilter },
